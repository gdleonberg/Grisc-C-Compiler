class tokenConverter:
    ...
    def __init__(self, tokens):
        ...
        self.conversions = [
            ...
            ["EQ_OP", ["==", ["punctuator"]]], 
            ["NE_OP", ["!=", ["punctuator"]]],
            ["LOGICAL_AND_OP", ["&&", ["punctuator"]]], 
            ["LOGICAL_OR_OP", ["||", ["punctuator"]]], 
            ["BITWISE_AND_OP", ["&", ["punctuator"]]], 
            ["BITWISE_OR_OP", ["|", ["punctuator"]]], 
            ["BITWISE_XOR_OP", ["^", ["punctuator"]]], 
            ["BITWISE_NOT_OP", ["~", ["punctuator"]]], 
            ["LOGICAL_NOT_OP", ["!", ["punctuator"]]], 
            ...
            ["TYPEDEF", ["typedef", ["reserved_word"]]],
            ["ENUM", ["enum", ["reserved_word"]]],
            ["DO", ["do", ["reserved_word"]]],
            ["CONST", ["const", ["reserved_word"]]],
            ["UNION", ["union", ["reserved_word"]]],
